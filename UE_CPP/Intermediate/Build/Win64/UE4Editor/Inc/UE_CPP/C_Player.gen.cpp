...
#endif
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam NewProp_AutoFireClass_MetaData[];
#endif
		static const UE4CodeGen_Private::FClassPropertyParams NewProp_AutoFireClass;
#if WITH_METADATA
...
#endif
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_AC_Player_Statics::NewProp_AutoFireClass_MetaData[] = {
		{ "Category", "UserInterface" },
		{ "ModuleRelativePath", "C_Player.h" },
	};
#endif
	const UE4CodeGen_Private::FClassPropertyParams Z_Construct_UClass_AC_Player_Statics::NewProp_AutoFireClass = { "AutoFireClass", nullptr, (EPropertyFlags)0x0044000000010001, UE4CodeGen_Private::EPropertyGenFlags::Class, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(AC_Player, AutoFireClass), Z_Construct_UClass_UC_UserWidget_NoRegister, Z_Construct_UClass_UClass, METADATA_PARAMS(Z_Construct_UClass_AC_Player_Statics::NewProp_AutoFireClass_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_AC_Player_Statics::NewProp_AutoFireClass_MetaData)) };
#if WITH_METADATA
...
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_AC_Player_Statics::NewProp_Parkour_MetaData[] = {
		{ "Category", "C_Player" },
		{ "EditInline", "true" },
		{ "ModuleRelativePath", "C_Player.h" },
	};
